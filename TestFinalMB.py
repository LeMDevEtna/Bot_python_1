...
global RSI_PERIOD
RSI_PERIOD = Variables_RSI.RSI_PERIOD
global in_position
global RSI_OVERSOLD
global RSI_OVERBOUGHT
RSI_OVERBOUGHT = Variables_RSI.RSI_OVERBOUGHT
RSI_OVERSOLD = Variables_RSI.RSI_OVERSOLD
global TRADE_SYMBOL
TRADE_SYMBOL = Variables_RSI.TRADE_SYMBOL
closes = Variables_RSI.closes

client = Variables_RSI.client
...
def on_message(ws,message):
    ...
    bought = 0
    global last_price 
    last_price = float(Variables_RSI.price)
    ...
    if is_candle_closed:
        ...
        Variables_RSI.closes.append(float(close))
        print("fermetures")
        #print(closes)
